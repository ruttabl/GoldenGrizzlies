...
CREATE TABLE `car` (
  ...
  `Car_Trim_ID` int NOT NULL,
  `Car_Horsepower` varchar(45) DEFAULT NULL,
  `Car_MPG` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Car_ID`),
  UNIQUE KEY `Car_ID_UNIQUE` (`Car_ID`),
  KEY `fk_Car_Manufacturer1_idx` (`Car_Make_ID`),
  KEY `fk_Car_Model1_idx` (`Car_Model_ID`),
  KEY `fk_Car_Trim1_idx` (`Car_Trim_ID`),
  CONSTRAINT `fk_Car_Manufacturer1` FOREIGN KEY (`Car_Make_ID`) REFERENCES `manufacturer` (`Man_Make_ID`),
  CONSTRAINT `fk_Car_Model1` FOREIGN KEY (`Car_Model_ID`) REFERENCES `model` (`Model_Model_ID`),
  CONSTRAINT `fk_Car_Trim1` FOREIGN KEY (`Car_Trim_ID`) REFERENCES `trim` (`Trim_Trim_ID`)
...
INSERT INTO `car` VALUES (1,'Blue',25000,1,0,'2021',2,1,1,'255','13'),(2,'Green',24934,1,0,'2022',1,6,3,'275','15'),(3,'Red',18203,1,1,'2020',1,2,5,'150','19'),(4,'Yellow',78324,0,0,'2021',3,3,6,'222','11'),(5,'Black',80345,0,0,'2022',3,9,7,'200','18'),(6,'Blue',24567,1,0,'2021',7,10,9,'180','14'),(7,'Purple',35034,0,0,'2020',5,4,2,'203','19'),(8,'White',36024,1,0,'2019',9,5,3,'205','24');
...
INSERT INTO `manufacturer` VALUES (1,'Chevrolet'),(2,'Ford'),(3,'Audi'),(4,'Jeep'),(5,'BMW'),(6,'Subaru'),(7,'Dodge'),(8,'GM'),(9,'Alfa Romeo'),(10,'Lexus'),(11,'Volvo'),(12,'Lincoln');
...
CREATE TABLE `model` (
  ...
  PRIMARY KEY (`Model_Model_ID`),
  KEY `fk_Model_Manufacturer1_idx` (`Model_Make_ID`),
  KEY `fk_Model_Trim1_idx` (`Model_Trim_ID`),
  CONSTRAINT `fk_Model_Manufacturer1` FOREIGN KEY (`Model_Make_ID`) REFERENCES `manufacturer` (`Man_Make_ID`),
...
INSERT INTO `model` VALUES (1,'Mustang',2,1),(2,'Malibu',1,6),(3,'A4',3,4),(4,'X5',5,2),(5,'Guilia',9,7),(6,'Camero',3,5),(7,'Continental',12,12),(8,'WRX',6,10),(9,'RS7',3,9),(10,'2500',7,4),(11,'CT5',8,11);
...
INSERT INTO `trim` VALUES (1,'Xs'),(2,'Xl'),(3,'M'),(4,'E'),(5,'T'),(6,'R'),(7,'B'),(8,'C'),(9,'X'),(10,'Re'),(11,'L'),(12,'V');
...
-- Dump completed on 2022-04-08 19:26:02
